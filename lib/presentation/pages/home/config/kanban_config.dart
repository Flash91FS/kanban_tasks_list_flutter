...
const kanbanBoardConfig = AppFlowyBoardConfig(
  // groupBackgroundColor: Color(0xffE7E8EC),
  groupBackgroundColor:  Color(0xFFBBDEFB), //blue100
  // groupBackgroundColor:  Color(0xffE6E6E7),
  stretchGroupHeight: false,
);

const kanbanTaskItemColor = Color(0xFFE3F2FD); //blue50
const kanbanCardSubtextColor = Color(0xff313439);  //todo change color of kanban-Card-Subtext here
