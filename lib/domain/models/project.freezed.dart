...
class _$ProjectImpl implements _Project {
  ...
  @override
  String toString() {
    return 'Project(id: $id, name: $name, commentCount: $commentCount, order: $order, color: $color, isShared: $isShared, isFavorite: $isFavorite, isInboxProject: $isInboxProject, isTeamInbox: $isTeamInbox, viewStyle: $viewStyle, parentId: $parentId, url: $url)';
  }
