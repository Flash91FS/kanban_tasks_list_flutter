    ...
    testWidgets('Kanban Home Page test', (WidgetTester tester) async {
      await tester.pumpWidget(MultiRepositoryProvider(
        ...
        child: MultiBlocProvider(
          ...
          child: const MaterialApp(home: Scaffold(body: KanbanPage(title: ''))),
        ),
      ));

      await tester.pumpAndSettle();

      expect(find.byKey(const Key('Key-AppBar')), findsOneWidget);
      expect(find.byKey(const Key('Key-KanbanBoard')), findsOneWidget);
    });
  });
}
